  ...
  },
{
  ...
  acsm11:{
    pageStr:"464-466",
    blocks:[
      {h:"11版阻力訓練起始強度（PDF p465）",body:"11版依上下肢分別規定起始強度：上肢從 40% 1-RM、下肢從 50% 1-RM 開始，再逐步增加至 70% 1-RM（歷時數週到數月）。12版改為統一 60–80% 1-RM，不分上下肢。",table:{head:["部位","11版起始","11版終點","12版"],rows:[["上肢","40% 1-RM","70% 1-RM","60–80% 1-RM"],["下肢","50% 1-RM","70% 1-RM","60–80% 1-RM"]]}},
      ...
      {h:"11版 HIIT 強度協定（PDF p466）",body:"11版明確列出 HF 可用 HIIT 協定：工作區間 30 秒至 4 分鐘、強度至 HRR 85–90%，交替 1–3 分鐘恢復期（HRR 50–70%）。12版未在 FITT 表中列出具體 HIIT 數值。",list:["工作：30 s–4 min，強度 85–90% HRR","恢復：1–3 min，強度 50–70% HRR","已完成最大運動測試者方可考慮 HIIT"]}
    ]
  }
  },
{
  ...
  },
{
  ...
  acsm11:{
    pageStr:"473",
    blocks:[
      {h:"11版阻力訓練起始強度（PDF p473）",body:"11版依上下肢分別規定：上肢 40% 1-RM、下肢 50% 1-RM 起始，逐步增至 70% 1-RM；1–2 組 × 10–15 下。12版改為 60–70% 1-RM，不分上下肢。",list:["11版上肢：40% 1-RM → 70% 1-RM","11版下肢：50% 1-RM → 70% 1-RM","12版：60–70% 1-RM（統一）"]}
    ]
  }
  },
{
  ...
  },
{
  ...
  acsm11:{
    pageStr:"477-479",
    blocks:[
      {h:"11版有氧強度 VO₂R 規定（PDF p478）",body:"11版明確以 40–59% VO₂R 為中強度目標，並以「最大步行速度 50–80%」作為替代指標。12版改以跛行疼痛量表（3–4/4 分）為強度終點，不再列出 VO₂R 百分比。",list:["11版：40–59% VO₂R（中強度），或最大步行速度 50–80%","12版：達跛行疼痛 3–4/4 分（不指定 VO₂R %）"]},
      {h:"11版阻力訓練細節（PDF p478）",body:"11版規定 2–3 組 × 8–12 下、6–8 個動作（強調下肢）；12版改為 1–2 組 × 10–15 下。阻力強度本身相同（60–80% 1-RM）。",table:{head:["項目","11版","12版"],rows:[["組數","2–3 組","1–2 組"],["次數","8–12 下","10–15 下"],["動作數","6–8 個（含下肢重點）","—（僅說多肌群）"],["強度","60–80% 1-RM","60–70% 1-RM"]]}}
    ]
  }
  },
{
  ...
  },
{
  ...
  acsm11:{
    pageStr:"481-482",
    blocks:[
      {h:"11版阻力訓練強度上限（PDF p482）",body:"11版阻力訓練強度範圍為 50–70% 1-RM；12版提升上限至 50–80% 1-RM（上限增加 10%）。",list:["11版：50–70% 1-RM","12版：50–80% 1-RM"]},
      {h:"11版有氧強度規定（PDF p482）",body:"11版有氧訓練強度以 40–70% HRR 為主；12版增加了 55–80% HRmax 作為等效替代，並新增 VO₂R 作為等效選項。",list:["11版：40–70% HRR（GXT 有資料時）","12版：40–70% HRR/VO₂R 或 55–80% HRmax"]}
    ]
  }
  },
{
  ...
  },
{
  ...
  acsm11:{
    pageStr:"498-499",
    blocks:[
      {h:"11版有氧強度 Borg CR10 範圍（PDF p498-499）",body:"11版 FITT 表明確列出 Borg CR10 4–6 作為 COPD 有氧強度目標。12版改為 3–6，降低了起始門檻。",list:["11版：CR10 4–6（最低強度感覺更明顯）","12版：CR10 3–6（接受更輕的感受強度）"]},
      {h:"11版有氧時間（PDF p499）",body:"11版 FITT 表直接列出 20–60 分鐘/天為目標（無需先從更短時間開始）。12版新增「前 3–5 次訓練先從 10–15 分鐘起始」的具體過渡期。",list:["11版：直接 20–60 min/d（以可耐受為前提）","12版：前 3–5 次先 10–15 min，再進展至 20–60 min"]}
    ]
  }
  },
{
